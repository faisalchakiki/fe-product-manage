  ...
  return (
    <div className='flex justify-center items-center min-h-screen'>
      <div className="lg:w-1/3 md:w-1/2 shadow-lg px-8 py-10 bg-white flex flex-col w-full border h-screen justify-center md:h-fit md:justify-normal">
        ...
        <p className="text-gray-500 mt-3 text-center text-xs md:text-lg">Don&apos;t have an account yet? <a onClick={() => navigate('/register')} className="text-blue font-semibold cursor-pointer">Sign Up</a>.</p>
      </div>
    </div>
  )
}
